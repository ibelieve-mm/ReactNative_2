...
import LikeCount from './app/components/LikeView.js';//导入喜欢数 组件
import Button from './app/components/ButtonView.js';//导入 自定义的按钮的 组件
import HomeUI from './app/pages/HomeUI.js';//导入 首页 组件
...
export default class ReactNative_2 extends Component {
    render() {
...
AppRegistry.registerComponent('ReactNative_2', () => ReactNative_2);
